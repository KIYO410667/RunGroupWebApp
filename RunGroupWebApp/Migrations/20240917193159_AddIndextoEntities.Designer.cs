...
namespace RunGroupWebApp.Migrations
{
    ...
    [Migration("20240917193159_AddIndextoEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RunGroupWebApp.Models.AppUserClub", b =>
                {
                    b.Property<string>("AppUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RunGroupWebApp.Models.AppUser", b =>
                {
                    b.HasOne("RunGroupWebApp.Models.Address", "Address")
                        .WithOne("AppUser")
                        .HasForeignKey("RunGroupWebApp.Models.AppUser", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("RunGroupWebApp.Models.AppUserClub", b =>
                {
                    b.HasOne("RunGroupWebApp.Models.AppUser", "AppUser")
                        .WithMany("AppUserClubs")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RunGroupWebApp.Models.Club", "Club")
                        .WithMany("AppUserClubs")
            ...
            modelBuilder.Entity("RunGroupWebApp.Models.Club", b =>
                {
                    b.HasOne("RunGroupWebApp.Models.Address", "Address")
                        .WithOne("Club")
                        .HasForeignKey("RunGroupWebApp.Models.Club", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
